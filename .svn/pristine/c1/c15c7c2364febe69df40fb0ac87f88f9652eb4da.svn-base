...
public class UpdateChannelTypeServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ChannelTypeControlModel  channelTypeControlModel =channelTypeControlDao.selectChannelTypeControlByctime(ctime);
		request.setAttribute("channelTypeControlModel",channelTypeControlModel);
		System.out.println(ctime);
		request.setAttribute("ctime",ctime);
		request.getRequestDispatcher("/static/jsp/channel/UpdateChannelType.jsp").forward(request,response);
